...
<body>
    ...
    <div style="height: 50px; width: 100%; background-color:#f6695e; text-align: center; line-height: 60px;">
        <h2 style="color: white;">DEPARTAMENTO</h2>
    </div>
    ...
    <div class="container text-center my-auto">
        <div class="m-4 d-flex justify-content-center align-items-center">
            ...
            <a href="admDepartamento.php" style="color: #f6695e; ">
                <button type="button" class="btn_agregar">Agregar Departamento</button>
            </a>
        </div>
    </div>
    <div class="col-6" style="height: 10px; width: 100px;"></div>
    <div class="container text-center my-auto">
        <div class="m-4 d-flex justify-content-center align-items-center">
            <?php
                ...
                $sql = "SELECT dptId, dptDescripcion FROM departamento";
