...
<body>
            ...
            <tr>
                ...
                <td align="right">
                    <table>
                        ...
                        <tr>
                            <td>
                                <a href="admListaDepartamentos.php">
    ...
    <div style="height: 50px; width: 100%; background-color:#f6695e; text-align: center; line-height: 60px;">
        <h2 style="color: white;">NUEVO DEPARTAMENTO</h2>
    </div>
    <div>
        <table width="100%">
            <tr>
                            ...
                            <div class="col-6">
                                <form method="post">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" id="departamento" name ="departamento">
                                    </div>
                                    <br>
                                    <!-- Cierre de visita -->
                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                        <input type="submit" class="btn_agregar" name ="guardarDepartamento" value="Ingresar Departamento">
                                    </div>
                                </form>
                            </div>
                        </div>
