...
<body>
    ...
    <div class="container text-center my-auto">
        <div class="m-4 d-flex justify-content-center align-items-center">
            ...
            <a href="admFuncionarios.php" style="color: #f6695e; ">
                <button type="button" class="btn_agregar">Agregar Funcionario</button>
            </a>
        </div>
    </div>
    <div class="col-6" style="height: 10px; width: 100px;"></div>
        ...
        <div class="m-4 d-flex justify-content-center align-items-center">
            <?php
                echo "<table width=\"100%\" style=\"border-collapse: separate;\">
                    <tr>
                        <th style=\"border: 1px solid #ff7f50;\">Cedula</th>
                ...
                $sql = "SELECT f.fncId, p.psrCedula, p.psrNombre, p.psrPrimerApellido, p.psrSegundoApellido, pst.pstPuesto, pst.pstSalario, h.hrrHoraEntrada, h.hrrHoraSalida, d.dptDescripcion
                FROM funcionario f
                JOIN persona p ON f.fncIdPersona = p.psrID
                JOIN puesto pst ON f.fncIdPuesto = pst.pstId
                JOIN horario h ON f.fncIdHorario = h.hrrID
                JOIN departamento d ON f.fncIdDepartamento = d.dptId";
                foreach ($db->query($sql) as $row) {
                    echo "<tr>
                        <td style=\"border: 1px solid #ff7f50;\">".$row["psrCedula"]."</td>
                        ...
                        <td style=\"border: 1px solid #ff7f50;\">".$row["hrrHoraEntrada"]." - ".$row["hrrHoraSalida"]."</td>
